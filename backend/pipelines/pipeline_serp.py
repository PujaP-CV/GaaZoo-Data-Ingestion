...
from modules.catalog_db import init_db, upsert_item
from modules.serp_client import fetch_and_prepare_serp
...
def run_serp_pipeline(
    ...
    """
    End-to-end: search Google Images → download one image per result → upsert into Neo4j.
